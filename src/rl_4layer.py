...
#-----
        if((msg.data[48:228]==100.0 and msg.data[46]>0.8 and msg.data[46]<20)):
            self.reward+=1
...
class Agent():
    def __init__(self, alpha=0.0003, beta=0.0003,input_dims=[228],
            ...
            layer1_size=256, layer2_size=256, batch_size=512, reward_scale=5):
        self.gamma = gamma
        self.tau = tau
...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, n_actions, fc1_dims=512, fc2_dims=512,fc3_dims=512,
                 fc4_dims=512, name='critic', 
                 chkpt_dir='/home/param/new_ws/src/p5/src/sac_4layer'):
...
class ValueNetwork(nn.Module):
    def __init__(self, beta, input_dims, fc1_dims=512, fc2_dims=512,fc3_dims=512, fc4_dims=512,
            name='value', chkpt_dir='/home/param/new_ws/src/p5/src/sac_4layer'):
...
class ActorNetwork(nn.Module):
    def __init__(self, alpha, input_dims , fc1_dims=512, fc3_dims=512,fc4_dims=512,
